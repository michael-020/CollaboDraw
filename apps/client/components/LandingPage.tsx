    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-900 bg-[radial-gradient(circle,_rgb(46,46,46)_0%,_rgb(5,5,5)_100%)] text-white p-4">
      <main className="text-center">
        ...
        <div className="flex justify-center space-x-4 mb-12">
          <Link
            href="/signin"
            className="bg-white text-emerald-600 px-8 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition duration-300"
          >
            Sign In
          </Link>
          <Link
            href="/signup"
            className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-semibold hover:bg-opacity-90 transition duration-300"
          >
            Sign Up
          </Link>
        </div>
